...
function beonepage_scripts() {
	...
	wp_localize_script( 'beonepage-app-script', 'app_vars', array(
		...
		'page_transition_spinner'  => Kirki::get_option( 'page_transition_spinner' ),
		'loading_spinner_color'    => Kirki::get_option( 'loading_spinner_color' ),
		'loading_background_color' => Kirki::get_option( 'loading_background_color' ),
		'progress_bar_color'       => Kirki::get_option( 'progress_bar_color' ),
