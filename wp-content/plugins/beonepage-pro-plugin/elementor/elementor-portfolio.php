<?php
    ...
    class Widget_My_Custom_Elementor_Portfolio extends Widget_Base {
    	...
    	protected function _register_controls() {
    		...
    		// Title
    		$beonepage_portfolio_module_title = beonepage_olddata_fetch('front_page_portfolio_module_title', 'option');
            ...
            //Sub title
    		$beonepage_portfolio_module_subtitle = beonepage_olddata_fetch('front_page_portfolio_module_subtitle', 'option');
    		...
    		//Caption Animation
    		$beonepage_portfolio_module_animation = beonepage_olddata_fetch('front_page_portfolio_module_animation', 'option');
    		...
    		//Font Color
    		$beonepage_portfolio_module_color = beonepage_olddata_fetch('front_page_portfolio_module_color', 'option');
    		...
    		$beonepage_portfolio_module_sp_color = beonepage_olddata_fetch('front_page_portfolio_module_sp_color', 'option');
    		...
    		//Separator Circle Color
    		$beonepage_portfolio_module_sp_i_color = beonepage_olddata_fetch('front_page_portfolio_module_sp_i_color', 'option');
            ...
            $beonepage_portfolio_module_show_all_hide = beonepage_olddata_fetch('front_page_portfolio_module_show_all_hide', 'option');
    		...
    		$class = '';
    		$attribute = '';    
            $beonepage_portfolio_module_bg = beonepage_olddata_fetch('front_page_portfolio_module_bg', 'option');
    		...
    		//Background Color
    		$beonepage_portfolio_module_bg_color = beonepage_olddata_fetch('front_page_portfolio_module_bg_color', 'option');
            ...
            //Background image 
            $beonepage_portfolio_module_bg_img = beonepage_olddata_fetch('front_page_portfolio_module_bg_img', 'option');
            ...
            // Background Repeat
            $beonepage_portfolio_module_bg_img_rp = beonepage_olddata_fetch('front_page_portfolio_module_bg_img', 'option');
            ...
            //Background Position
            $beonepage_portfolio_module_bg_img_bp = beonepage_olddata_fetch('front_page_portfolio_module_bg_img', 'option');
            ...
            //Background Size
            $beonepage_portfolio_module_bg_img_bs = beonepage_olddata_fetch('front_page_portfolio_module_bg_img', 'option');
            ...
            $beonepage_portfolio_module_bg_img_ath = beonepage_olddata_fetch('front_page_portfolio_module_bg_img', 'option');
            ...
            $beonepage_portfolio_module_bg_video = beonepage_olddata_fetch('front_page_portfolio_module_bg_video', 'option');
    			if(!empty($beonepage_portfolio_module_bg_video)){
    				$beonepage_portfolio_module_bg_video = beonepage_olddata_fetch('front_portfolio_table_module_bg_video', 'option');
            ...
            //Parallax seting
            $beonepage_portfolio_module_bg_parallax = beonepage_olddata_fetch('front_page_portfolio_module_bg_parallax', 'option');
            ...
            $beonepage_portfolio_module_filter = beonepage_olddata_fetch('front_page_portfolio_module_filter', 'option');
    		...
    		//Filter Animation
    		$beonepage_portfolio_module_filter_animation = beonepage_olddata_fetch('front_page_portfolio_module_filter_animation', 'option');
    		...
    		$beonepage_portfolio_module_all = beonepage_olddata_fetch('front_page_portfolio_module_all', 'option');
    		...
    		//Filter Font Color
    		$beonepage_portfolio_module_filter_color = beonepage_olddata_fetch('front_page_portfolio_module_filter_color', 'option');
    		...
    		$beonepage_portfolio_module_filter_bg_color = beonepage_olddata_fetch('front_page_portfolio_module_filter_bg_color', 'option');
    		...
    		$beonepage_portfolio_module_item_bg_color = beonepage_olddata_fetch('front_page_portfolio_module_item_bg_color', 'option');
    			if(!empty($beonepage_portfolio_module_item_bg_color)){
    				$beonepage_portfolio_module_item_bg_color = beonepage_olddata_fetch('front_page_portfolio_module_item_bg_color', 'option');
    			}else{
    		...
    		$beonepage_portfolio_module_item_title_color = beonepage_olddata_fetch('front_page_portfolio_module_item_title_color', 'option');
    		...
    		$beonepage_portfolio_module_item_tag_color = beonepage_olddata_fetch('front_page_portfolio_module_item_tag_color', 'option');
    	...
    	$beonepage_portfolio_module_item_column_number = beonepage_olddata_fetch('front_page_portfolio_module_item_column_number', 'option');
    		...
    		$beonepage_portfolio_module_modal_title_color = beonepage_olddata_fetch('front_page_portfolio_module_modal_title_color', 'option');
    		...
    		$beonepage_portfolio_module_modal_content_color = beonepage_olddata_fetch('front_page_portfolio_module_modal_content_color', 'option');
    		...
    		$beonepage_portfolio_module_modal_sp_color = beonepage_olddata_fetch('front_page_portfolio_module_modal_sp_color', 'option');
    		...
    		$beonepage_portfolio_module_modal_bg_color = beonepage_olddata_fetch('front_page_portfolio_module_modal_bg_color', 'option');
    			if(!empty($portfolio_module_modal_bg_color)){
    				$portfolio_module_modal_bg_color = beonepage_olddata_fetch('front_page_portfolio_module_modal_bg_color', 'option');
    			}else{
