...
class Widget_My_Custom_Elementor_Contact extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Title
		$beonepage_contact_module_title = beonepage_olddata_fetch('front_page_contact_module_title', 'option');
        ...
        //Sub title
		$beonepage_contact_module_subtitle = beonepage_olddata_fetch('front_page_contact_module_subtitle', 'option');
		...
		//Caption Animation
		$beonepage_contact_module_animation = beonepage_olddata_fetch('front_page_contact_module_animation', 'option');
		...
		// Font Color
		$beonepage_contact_module_color = beonepage_olddata_fetch('front_page_contact_module_color', 'option');
		...
		$beonepage_contact_module_sp_color = beonepage_olddata_fetch('front_page_contact_module_sp_color', 'option');
		...
		$beonepage_contact_module_sp_i_color = beonepage_olddata_fetch('front_page_contact_module_sp_i_color', 'option');
		...
		$class = '';
		$attribute = '';    
        $beonepage_contact_module_bg = beonepage_olddata_fetch('front_page_contact_module_bg', 'option');
		...
		$beonepage_contact_module_bg_color = beonepage_olddata_fetch('front_page_contact_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_contact_module_bg_img = beonepage_olddata_fetch('front_page_contact_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_contact_module_bg_img_rp = beonepage_olddata_fetch('front_page_contact_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_contact_module_bg_img_bp = beonepage_olddata_fetch('front_page_contact_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_contact_module_bg_img_bs = beonepage_olddata_fetch('front_page_contact_module_bg_img', 'option');
        ...
        $beonepage_contact_module_bg_img_ath = beonepage_olddata_fetch('front_page_contact_module_bg_img', 'option');
        ...
        $beonepage_contact_module_bg_video = beonepage_olddata_fetch('front_page_contact_module_bg_video', 'option');
			if(!empty($beonepage_contact_module_bg_video)){
				$beonepage_contact_module_bg_video = beonepage_olddata_fetch('front_contact_table_module_bg_video', 'option');
        ...
        //Parallax setting
        $beonepage_contact_module_bg_parallax = beonepage_olddata_fetch('front_page_contact_module_bg_parallax', 'option');
		...
		$beonepage_contact_module_cf_animation = beonepage_olddata_fetch('front_page_contact_module_cf_animation', 'option');
		...
		// Send Button Text
		$beonepage_contact_module_send = beonepage_olddata_fetch('front_page_contact_module_send', 'option');
		...
		//Button Style
		$beonepage_contact_module_btn_style = beonepage_olddata_fetch('front_page_contact_module_btn_style', 'option');
		...
		// Enable Google Maps?
        $beonepage_contact_module_gmap = beonepage_olddata_fetch('front_page_contact_module_gmap', 'option');
		...
		// Latitude
		$beonepage_contact_module_gmap_lat = beonepage_olddata_fetch('front_page_contact_module_gmap_lat', 'option');
		...
		// Longitude
		$beonepage_contact_module_gmap_lng = beonepage_olddata_fetch('front_page_contact_module_gmap_lng', 'option');
		...
		// Google Maps API key
		$beonepage_contact_module_gmap_api_key = beonepage_olddata_fetch('front_page_contact_module_gmap_api_key', 'option');
		...
		$beonepage_contact_module_email = beonepage_olddata_fetch('front_page_contact_module_email', 'option');
        ...
        $front_page_contact_module_enable_privacy = beonepage_olddata_fetch('front_page_contact_module_enable_privacy', 'option');
		...
		//Contact Form Animation
		$beonepage_contact_module_cf_privacy_page = beonepage_olddata_fetch('front_page_contact_module_cf_privacy_page', 'option');
		...
		$result = array();
			...
			'section_contact_boxes',
				[
					...
					'fields' 	=> [				
						[
						'name' 		=> 'section_contact_box_label',
						'label' 	=> __( "Label", 'beonepage' ),
						'type' 		=> Controls_Manager::TEXT,
						],
						[
						'name' 		=> 'section_contact_box_description',
						'label' 	=> 	__( "Description", 'beonepage' ),
						'type' 		=> 	Controls_Manager::TEXTAREA,
						'rows' 		=> 	7,
						],
						[
						'name' 		=> 'section_contact_box_icon',
						'label' 	=> 	__( "Icon", 'beonepage' ),
						'type' 		=> 	Controls_Manager::ICON,
						
						],
						[
						'name' 		=> 'section_contact_box_url',
						'label' 	=> __( "URL", 'beonepage' ),
						'type' 		=> Controls_Manager::TEXT,
						'placeholder' => __( 'https://your-link.com', 'beonepage' ),
						],
						[
						'name' 		=> 'section_contact_box_animation',
...
protected function render( $instance = [] ) {
    ...
    if ( $beonepage_contact_module_bg == 'video' ) {
        $class .= 'yt-bg-player';
        $attribute .= ' data-yt-video="' . beonepage_olddata_fetch('front_page_contact_module_bg_video', 'option'). '"';
