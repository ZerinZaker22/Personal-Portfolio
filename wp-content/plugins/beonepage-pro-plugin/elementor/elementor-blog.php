...
class Widget_My_Custom_Elementor_blog extends Widget_Base {
	...
	protected function _register_controls() {
		...
		//Title
		$beonepage_blog_module_title = beonepage_olddata_fetch('front_page_blog_module_title', 'option');
        ...
        //Sub title
		$beonepage_blog_module_subtitle = beonepage_olddata_fetch('front_page_blog_module_subtitle', 'option');
		...
		//Caption Animation
		$beonepage_blog_module_animation = beonepage_olddata_fetch('front_page_blog_module_animation', 'option');
		...
		//Font Color
		$beonepage_blog_module_color = beonepage_olddata_fetch('front_page_blog_module_color', 'option');
		...
		$beonepage_blog_module_sp_color = beonepage_olddata_fetch('front_page_blog_module_sp_color', 'option');
		...
		//Separator Circle Color
		$beonepage_blog_module_sp_i_color = beonepage_olddata_fetch('front_page_blog_module_sp_i_color', 'option');
		...
		$class = '';
		$attribute = '';    
        $beonepage_blog_module_bg = beonepage_olddata_fetch('front_page_blog_module_bg', 'option');
        if(!empty($beonepage_blog_module_bg)){
			$beonepage_blog_module_bg = beonepage_olddata_fetch('front_page_blog_module_bg', 'option');
        }else{
			$beonepage_blog_module_bg = esc_attr("color");
        }       
        $beonepage_blog_module_bg_parallax = beonepage_olddata_fetch('front_page_blog_module_bg_parallax', 'option');
		...
		if ( $beonepage_blog_module_bg == 'video' ) {
			$class .= 'yt-bg-player';
			$attribute .= ' data-yt-video="' . beonepage_olddata_fetch('front_page_blog_module_bg_video', 'option'). '"';
		}   
		//Background Color
		$beonepage_blog_module_bg_color = beonepage_olddata_fetch('front_page_blog_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_blog_module_bg_img = beonepage_olddata_fetch('front_page_blog_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_blog_module_bg_img_rp = beonepage_olddata_fetch('front_page_blog_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_blog_module_bg_img_bp = beonepage_olddata_fetch('front_page_blog_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_blog_module_bg_img_bs = beonepage_olddata_fetch('front_page_blog_module_bg_img', 'option');
        ...
        $beonepage_blog_module_bg_img_ath = beonepage_olddata_fetch('front_page_blog_module_bg_img', 'option');
        ...
        $beonepage_blog_module_bg_video = beonepage_olddata_fetch('front_page_blog_module_bg_video', 'option');
			if(!empty($beonepage_blog_module_bg_video)){
				$beonepage_blog_module_bg_video = beonepage_olddata_fetch('front_blog_table_module_bg_video', 'option');
		...
		$beonepage_blog_module_pd_color = beonepage_olddata_fetch('front_page_blog_module_pd_color', 'option');
		...
		$beonepage_blog_module_pd_bg_color = beonepage_olddata_fetch('front_page_blog_module_pd_bg_color', 'option');
			if(!empty($beonepage_blog_module_pd_bg_color)){
				$beonepage_blog_module_pd_bg_color = beonepage_olddata_fetch('front_page_blog_module_pd_bg_color', 'option');
			}else{
		...
		$beonepage_blog_module_read_more = beonepage_olddata_fetch('front_page_blog_module_read_more', 'option');
		...
		$beonepage_blog_module_rm_color = beonepage_olddata_fetch('front_page_blog_module_rm_color', 'option');
		...
		$beonepage_blog_module_rm_bg_color = beonepage_olddata_fetch('front_page_blog_module_rm_bg_color', 'option');
			if(!empty($beonepage_blog_module_rm_bg_color)){
				$beonepage_blog_module_rm_bg_color = beonepage_olddata_fetch('front_page_blog_module_rm_bg_color', 'option');
			}else{
		...
		$beonepage_blog_module_view_more = beonepage_olddata_fetch('front_page_blog_module_view_more', 'option');
		...
		$beonepage_blog_module_vw_color = beonepage_olddata_fetch('front_page_blog_module_vw_color', 'option');
		...
		$beonepage_blog_module_vw_icon_color = beonepage_olddata_fetch('front_page_blog_module_vw_icon_color', 'option');
		...
		$beonepage_blog_module_vw_bg_color = beonepage_olddata_fetch('front_page_blog_module_vw_bg_color', 'option');
