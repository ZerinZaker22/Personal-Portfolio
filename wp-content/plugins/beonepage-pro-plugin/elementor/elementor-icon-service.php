...
class Widget_My_Custom_Elementor_Icon_Service extends Widget_Base {
	...
	protected function _register_controls() {	
		...
		//Title
		$beonepage_icon_service_module_title = beonepage_olddata_fetch('front_page_icon_service_module_title', 'option');
		...
		//Subtitle
		$beonepage_icon_service_module_subtitle = beonepage_olddata_fetch('front_page_icon_service_module_subtitle', 'option');
		...
		//Caption Animation
		$beonepage_icon_service_module_animation = beonepage_olddata_fetch('front_page_icon_service_module_animation', 'option');
		...
		//Font Color
		$beonepage_icon_service_module_color = beonepage_olddata_fetch('front_page_icon_service_module_color', 'option');
		...
		$beonepage_icon_service_module_sp_color = beonepage_olddata_fetch('front_page_icon_service_module_sp_color', 'option');
		...
		$beonepage_icon_service_module_sp_i_color = beonepage_olddata_fetch('front_page_icon_service_module_sp_i_color', 'option');
		...
		$beonepage_icon_service_module_hover_color = beonepage_olddata_fetch('front_page_icon_service_module_hover_color', 'option');
		...
		$class = '';
		$attribute = '';
		$beonepage_icon_service_module_bg = beonepage_olddata_fetch('front_page_icon_service_module_bg', 'option');
		...
		//Background Color		
		$beonepage_icon_service_module_bg_color = beonepage_olddata_fetch('front_page_icon_service_module_bg_color', 'option');
		...
		//Background image
		$beonepage_icon_service_module_bg_img = beonepage_olddata_fetch('front_page_icon_service_module_bg_img', 'option');
		...
		// Background Repeat
		$beonepage_icon_service_module_bg_img_rp = beonepage_olddata_fetch('front_page_icon_service_module_bg_img', 'option');
		...
		//Background Position
		$beonepage_icon_service_module_bg_img_bp = beonepage_olddata_fetch('front_page_icon_service_module_bg_img', 'option');
		...
		//Background Size
		$beonepage_icon_service_module_bg_img_bs = beonepage_olddata_fetch('front_page_icon_service_module_bg_img', 'option');
		...
		$beonepage_icon_service_module_bg_img_ath = beonepage_olddata_fetch('front_page_icon_service_module_bg_img', 'option');
		...
		$beonepage_icon_service_module_bg_video = beonepage_olddata_fetch('front_page_icon_service_module_bg_video', 'option');
		...
		//Parallax seting
		$beonepage_icon_service_module_bg_parallax = beonepage_olddata_fetch('front_page_icon_service_module_bg_parallax', 'option');
...
protected function render( $instance = [] ) {
	...
	$beonepage_icon_service_module_layout = beonepage_olddata_fetch('front_page_icon_service_module_layout', 'option');
		
	$class = '';
	$attribute = '';
		$beonepage_icon_service_module_bg1 = beonepage_olddata_fetch('front_page_icon_service_module_bg', 'option');
