...
class Widget_My_Custom_Elementor_twitter extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$beonepage_twitter_twitter_animation = beonepage_olddata_fetch('front_page_twitter_twitter_animation', 'option');
		...
		// Twitter Username
		$beonepage_twitter_twitter_username = beonepage_olddata_fetch('front_page_twitter_twitter_username', 'option');
		...
		// Consumer Key
		$beonepage_twitter_twitter_tck = beonepage_olddata_fetch('front_page_twitter_twitter_tck', 'option');
		...
		// Consumer Secret
		$beonepage_twitter_twitter_tcs = beonepage_olddata_fetch('front_page_twitter_twitter_tcs', 'option');
		...
		// Access Token
		$beonepage_twitter_twitter_tat = beonepage_olddata_fetch('front_page_twitter_twitter_tat', 'option');
		...
		// Access Token Secret
		$beonepage_twitter_twitter_tats = beonepage_olddata_fetch('front_page_twitter_twitter_tats', 'option');
		...
		// Button Text
		$beonepage_twitter_btn_text = beonepage_olddata_fetch('front_page_twitter_btn_text', 'option');
		...
		// Button URL
		$beonepage_twitter_btn_url = beonepage_olddata_fetch('front_page_twitter_btn_url', 'option');
		if(!empty($beonepage_twitter_btn_url)){
			$beonepage_hor_twitter_url = beonepage_olddata_fetch('front_page_twitter_btn_url', 'option');
		}else{
		...
		//Button Animation
		$beonepage_twitter_btn_animation = beonepage_olddata_fetch('front_page_twitter_btn_animation', 'option');
		...
		//Button Style
		$beonepage_twitter_btn_style = beonepage_olddata_fetch('front_page_twitter_btn_style', 'option');
		...
		//Font Color
       $beonepage_twitter_color = beonepage_olddata_fetch('front_page_twitter_color', 'option');
       ...
       $beonepage_twitter_link_color = beonepage_olddata_fetch('front_page_twitter_link_color', 'option');
		...
		$class = '';
		$attribute = '';    
        $beonepage_twitter_module_bg = beonepage_olddata_fetch('front_page_twitter_module_bg', 'option');
		...
		//Background Color
		$beonepage_twitter_module_bg_color = beonepage_olddata_fetch('front_page_twitter_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_twitter_module_bg_img = beonepage_olddata_fetch('front_page_twitter_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_twitter_module_bg_img_rp = beonepage_olddata_fetch('front_page_twitter_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_twitter_module_bg_img_bp = beonepage_olddata_fetch('front_page_twitter_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_twitter_module_bg_img_bs = beonepage_olddata_fetch('front_page_twitter_module_bg_img', 'option');
        ...
        $beonepage_twitter_module_bg_img_ath = beonepage_olddata_fetch('front_page_twitter_module_bg_img', 'option');
        ...
        $beonepage_twitter_module_bg_video = beonepage_olddata_fetch('front_page_twitter_module_bg_video', 'option');
			if(!empty($beonepage_twitter_module_bg_video)){
				$beonepage_twitter_module_bg_video = beonepage_olddata_fetch('front_twitter_table_module_bg_video', 'option');
		...
		//Parallax setting
        $beonepage_twitter_module_bg_parallax = beonepage_olddata_fetch('front_page_twitter_module_bg_parallax', 'option');
