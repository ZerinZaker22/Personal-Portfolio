...
class Widget_My_Custom_Elementor_widget extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Title
		$beonepage_widget_module_title = beonepage_olddata_fetch('front_page_widget_module_title', 'option');
        ...
        //Sub title
		$beonepage_widget_module_subtitle = beonepage_olddata_fetch('front_page_widget_module_subtitle', 'option');
		...
		//Caption Animation
		$beonepage_widget_module_animation = beonepage_olddata_fetch('front_page_widget_module_animation', 'option');
		...
		// Font Color
		$beonepage_widget_module_color = beonepage_olddata_fetch('front_page_widget_module_color', 'option');
		...
		//Separator Line
		$beonepage_widget_module_sp_color = beonepage_olddata_fetch('front_page_widget_module_sp_color', 'option');
		...
		//Separator Circle
		$beonepage_widget_module_sp_i_color = beonepage_olddata_fetch('front_page_widget_module_sp_i_color', 'option');
		...
		$class = '';
		$attribute = '';    
        $beonepage_widget_module_bg = beonepage_olddata_fetch('front_page_widget_module_bg', 'option');
		...
		//Background Color
		$beonepage_widget_module_bg_color = beonepage_olddata_fetch('front_page_widget_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_widget_module_bg_img = beonepage_olddata_fetch('front_page_widget_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_widget_module_bg_img_rp = beonepage_olddata_fetch('front_page_widget_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_widget_module_bg_img_bp = beonepage_olddata_fetch('front_page_widget_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_widget_module_bg_img_bs = beonepage_olddata_fetch('front_page_widget_module_bg_img', 'option');
        ...
        $beonepage_widget_module_bg_img_ath = beonepage_olddata_fetch('front_page_widget_module_bg_img', 'option');
        ...
        $beonepage_widget_module_bg_video = beonepage_olddata_fetch('front_page_widget_module_bg_video', 'option');
			if(!empty($beonepage_widget_module_bg_video)){
				$beonepage_widget_module_bg_video = beonepage_olddata_fetch('front_widget_table_module_bg_video', 'option');
        ...
        //Parallax setting
        $beonepage_widget_module_bg_parallax = beonepage_olddata_fetch('front_page_widget_module_bg_parallax', 'option');
		...
		//Widget Area
		$result = array();
		$beonepage_widget_module_widget = beonepage_olddata_fetch('front_page_widget_module_widget', 'option');
			if(!empty($beonepage_widget_module_widget)){
				$beonepage_widget_module_widget = beonepage_olddata_fetch('front_page_widget_module_widget', 'option');
				
				foreach ( $beonepage_widget_module_widget as $module_widget ) :
					$result[] = array('widget_area_name' => $module_widget['widget_name'] , 'select_type' => $module_widget['widget_num']);	
				endforeach;
			}else{
		...
		'widget_area', 
			[
				...
				'fields' 	=> [
					...
					[
						'name' 	=> 'select_type', 
						'label' => __( 'Select Type', 'beonepage' ),
						'type' 	=> Controls_Manager::SELECT,
						'options' => [
							'1' => __( '1', 'beonepage' ),
							'2' => __( '2', 'beonepage' ),
	...
	//layout
	$beonepage_widget_module_layout = beonepage_olddata_fetch('front_page_widget_module_layout', 'option');
?>
<section id="widget" class="module widget-module<?php echo $class; ?> clearfix"<?php echo $attribute; ?>>
	<div class="<?php echo $beonepage_widget_module_layout == 'fixed' ? 'container' : 'container-fluid'; ?>">
		<div class="row">
			...
			<?php $widgets = $settings['widget_area']; ?>
