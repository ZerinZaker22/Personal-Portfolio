...
class Widget_My_Custom_Elementor_hor_Promo extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Title
		$beonepage_hor_promo_module_title = beonepage_olddata_fetch('front_page_hor_promo_title', 'option');
		...
		//Heading Animation
		$beonepage_hor_promo_module_title_animation = beonepage_olddata_fetch('front_page_hor_promo_title_animation', 'option');
        ...
        //Content
		$beonepage_hor_promo_content = beonepage_olddata_fetch('front_page_hor_promo_content', 'option');
		...
		//Content Animation
		$beonepage_hor_promo_content_animation = beonepage_olddata_fetch('front_page_hor_promo_content_animation', 'option');
		...
		//Button TEXT
		$beonepage_hor_promo_btn_text = beonepage_olddata_fetch('front_page_hor_promo_btn_text', 'option');
		...
		//Button Url
		$beonepage_hor_promo_btn_url = beonepage_olddata_fetch('front_page_hor_promo_btn_url', 'option');
		...
		//Button Animation
		$beonepage_hor_promo_btn_animation = beonepage_olddata_fetch('front_page_hor_promo_btn_animation', 'option');
		...
		//Button Style
		$beonepage_hor_promo_btn_style1 = beonepage_olddata_fetch('front_page_hor_promo_btn_style1', 'option');
		...
		//Font Color
       $beonepage_hor_promo_color = beonepage_olddata_fetch('front_page_hor_promo_color', 'option');
		...
		$class = '';
		$attribute = '';   
        $beonepage_hor_promo_module_bg = beonepage_olddata_fetch('front_page_hor_promo_module_bg', 'option');
        ...
        //Background Color
		$beonepage_hor_promo_module_bg_color = beonepage_olddata_fetch('front_page_hor_promo_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_hor_promo_module_bg_img = beonepage_olddata_fetch('front_page_hor_promo_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_hor_promo_module_bg_img_rp = beonepage_olddata_fetch('front_page_hor_promo_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_hor_promo_module_bg_img_bp = beonepage_olddata_fetch('front_page_hor_promo_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_hor_promo_module_bg_img_bs = beonepage_olddata_fetch('front_page_hor_promo_module_bg_img', 'option');
        ...
        $beonepage_hor_promo_module_bg_img_ath = beonepage_olddata_fetch('front_page_hor_promo_module_bg_img', 'option');
        ...
        //Parallax seting
        $beonepage_hor_promo_module_bg_parallax = beonepage_olddata_fetch('front_page_hor_promo_module_bg_parallax', 'option');
