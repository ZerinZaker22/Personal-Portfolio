...
class Widget_My_Custom_Elementor_Process extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Title
		$beonepage_process_module_title = beonepage_olddata_fetch('front_page_process_module_title', 'option');
		...
		//Sub Title
		$beonepage_process_module_subtitle = beonepage_olddata_fetch('front_page_process_module_subtitle', 'option');
		...
		//Caption Animation
		$beonepage_process_module_animation = beonepage_olddata_fetch('front_page_process_module_animation', 'option');
        ...
        //Font Color
        $beonepage_process_module_color = beonepage_olddata_fetch('front_page_process_module_color', 'option');
        ...
        $beonepage_process_module_sp_color = beonepage_olddata_fetch('front_page_process_module_sp_color', 'option');
		if(!empty($beonepage_process_module_sp_color)){
			$beonepage_process_module_sp_color = beonepage_olddata_fetch('front_page_process_module_sp_color', 'option');
        }else{
			$beonepage_process_module_sp_color = esc_atte("#888");
        }      
        $this->add_control(
        ...
        $beonepage_process_module_sp_i_color = beonepage_olddata_fetch('front_page_process_module_sp_i_color', 'option');
		...
		//Process Label Color
        $beonepage_process_module_hover_label_color = beonepage_olddata_fetch('front_page_process_module_label_color', 'option');
        ...
        //active color         
        $beonepage_process_module_active_color = beonepage_olddata_fetch('front_page_process_module_active_color', 'option');
        if(!empty($beonepage_process_module_active_color)){
			$beonepage_process_module_active_color = beonepage_olddata_fetch('front_page_process_module_active_color', 'option');
        }else{
			$beonepage_process_module_active_color = ecs_attr("#ffcc00");
        }
        $this->add_control(
		...
		$class = '';
		$attribute = '';  
        $beonepage_process_module_bg = beonepage_olddata_fetch('front_page_process_module_bg', 'option');
		...
		//Background Color
		$beonepage_process_module_bg_color = beonepage_olddata_fetch('front_page_process_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_process_module_bg_img = beonepage_olddata_fetch('front_page_process_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_process_module_bg_img_rp = beonepage_olddata_fetch('front_page_process_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_process_module_bg_img_bp = beonepage_olddata_fetch('front_page_process_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_process_module_bg_img_bs = beonepage_olddata_fetch('front_page_process_module_bg_img', 'option');
        ...
        $beonepage_process_module_bg_img_ath = beonepage_olddata_fetch('front_page_process_module_bg_img', 'option');
        ...
        $beonepage_process_module_bg_video = beonepage_olddata_fetch('front_page_process_module_bg_video', 'option');
        ...
        //Parallax seting
        $beonepage_process_module_bg_parallax = beonepage_olddata_fetch('front_page_process_module_bg_parallax', 'option');
		...
		'section_option_process_boxes',
			[
				...
				'fields' 	=> [				
					...
					[
					'name' 		=> 'section_process_description',
					'label' 	=> 	__( "Description", 'beonepage' ),
					'type' 		=> 	Controls_Manager::TEXTAREA,
					'rows' 		=> 	7,
					],
					[
					'name' 		=> 'section_process_icon',
					'label' 	=> 	__( "Icon", 'beonepage' ),
					'type' 		=> 	Controls_Manager::ICON,
					
					],
					[
					'name' 		=> 'section_process_animation',
