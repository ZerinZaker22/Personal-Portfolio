...
class Widget_My_Custom_Elementor_Fun_Fact extends Widget_Base {
   ...
   protected function _register_controls() {
		...
		//Font Color
        $beonepage_fun_fact_color = beonepage_olddata_fetch('front_page_fun_fact_color', 'option');
        ...
        //Label Color
        $beonepage_fun_fact_module_label = beonepage_olddata_fetch('front_page_fun_fact_module_label', 'option');
        if(!empty($beonepage_fun_fact_module_label)){
			$beonepage_fun_fact_module_label = beonepage_olddata_fetch('front_page_fun_fact_module_label', 'option');
        }else{
			$beonepage_fun_fact_module_label = esc_atte("#ffcc00");
        }        
        $this->add_control(
			'section_label_color',
			[
		...
		$class = '';
		$attribute = '';   
        $beonepage_fun_fact_module_bg = beonepage_olddata_fetch('front_page_fun_fact_module_bg', 'option');
		...
		$beonepage_fun_fact_module_bg_color = beonepage_olddata_fetch('front_page_fun_fact_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_fun_fact_module_bg_img = beonepage_olddata_fetch('front_page_fun_fact_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_fun_fact_module_bg_img_rp = beonepage_olddata_fetch('front_page_fun_fact_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_fun_fact_module_bg_img_bp = beonepage_olddata_fetch('front_page_fun_fact_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_fun_fact_module_bg_img_bs = beonepage_olddata_fetch('front_page_fun_fact_module_bg_img', 'option');
        ...
        $beonepage_fun_fact_module_bg_img_ath = beonepage_olddata_fetch('front_page_fun_fact_module_bg_img', 'option');
        ...
        //Parallax seting
        $beonepage_fun_fact_module_bg_parallax = beonepage_olddata_fetch('front_page_fun_fact_module_bg_parallax', 'option');
		...
		// Fun Fact REPEATER
		$result = array();
		$beonepage_fun_fact_module_fact = beonepage_olddata_fetch('front_page_fun_fact_module_fact', 'option');
        ...
        'section_fun_fact',
			[
				...
				'fields' 	=> [
					[
					'name' 		=> 'section_fun_fact_label',
					'label' 	=> __( 'Fact Label', 'beonepage' ),
					'type' 		=> Controls_Manager::TEXT,
					'label_block' => true,
					],
					[
					'name' 		=> 'section_fun_fact_number',
	...
	$beonepage_fun_fact_module_layout = beonepage_olddata_fetch('front_page_fun_fact_module_layout', 'option');
	$class = '';
	$attribute = '';   
