...
class Widget_My_Custom_Elementor_Skill_Bar extends Widget_Base {
	...
	protected function _register_controls() {
		...
		//Title
		$beonepage_skill_bar_module_title = beonepage_olddata_fetch('front_page_skill_bar_module_title', 'option');
		...
		//subtitle
		$beonepage_skill_bar_module_subtitle = beonepage_olddata_fetch('front_page_skill_bar_module_subtitle', 'option');
		...
		//Title Animation
		$beonepage_skill_bar_module_animation = beonepage_olddata_fetch('front_page_skill_bar_module_animation', 'option');
		...
		//Font Color
		$beonepage_skill_bar_module_color = beonepage_olddata_fetch('front_page_skill_bar_module_color', 'option');
		...
		$beonepage_skill_bar_module_sp_color = beonepage_olddata_fetch('front_page_skill_bar_module_sp_color', 'option');
		...
		$beonepage_skill_bar_module_sp_i_color = beonepage_olddata_fetch('front_page_skill_bar_module_sp_i_color', 'option');
		...
		$beonepage_skill_bar_module_pct = beonepage_olddata_fetch('front_page_skill_bar_module_pct', 'option');
		...
		$class = '';
		$attribute = '';
		$beonepage_skill_bar_module_bg = beonepage_olddata_fetch('front_page_skill_bar_module_bg', 'option');
		...
		//Background Color
		$beonepage_skill_bar_module_bg_color = beonepage_olddata_fetch('front_page_skill_bar_module_bg_color', 'option');
		...
		$beonepage_skill_bar_module_bg_color_img = beonepage_olddata_fetch('front_page_skill_bar_module_bg_img', 'option');
		...
		//Background image
		$beonepage_skill_bar_module_bg_img = beonepage_olddata_fetch('front_page_skill_bar_module_bg_img', 'option');
		...
		// Background Repeat
        $beonepage_skill_bar_module_bg_img_rp = beonepage_olddata_fetch('front_page_skill_bar_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_skill_bar_module_bg_img_bp = beonepage_olddata_fetch('front_page_skill_bar_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_skill_bar_module_bg_img_bs = beonepage_olddata_fetch('front_page_skill_bar_module_bg_img', 'option');
        ...
        $beonepage_skill_bar_module_bg_img_ath = beonepage_olddata_fetch('front_page_skill_bar_module_bg_img', 'option');
		...
		$beonepage_skill_bar_module_bg_video = beonepage_olddata_fetch('front_page_skill_bar_module_bg_video', 'option');
		...
		//Parallax Scrolling
		$beonepage_skill_bar_module_bg_parallax = beonepage_olddata_fetch('front_page_skill_bar_module_bg_parallax', 'option');
		...
		//Content Box
		$beonepage_skill_bar_module_text = beonepage_olddata_fetch('front_page_skill_bar_module_text', 'option');
		...
		$beonepage_skill_bar_module_text_animation = beonepage_olddata_fetch('front_page_skill_bar_module_text_animation', 'option');
		if(!empty($beonepage_skill_bar_module_text_animation)){
			$beonepage_skill_bar_module_text_animation = beonepage_olddata_fetch('front_page_skill_bar_module_text_animation', 'option');
		}else{
			$beonepage_skill_bar_module_text_animation =wp_kses("bounceInLeft");
		}
		$this->add_control(
		...
		// Skill Bar REPEATER
		$result = array();
		$beonepage_skill_bar_module_skill_bar = beonepage_olddata_fetch('front_page_skill_bar_module_skill_bar', 'option');
        ...
        'section_skill_bar',
			[
				...
				'fields' => [
					[
					'name' 		=> 'section_skill_bar_label',
					'label' 	=> __( 'Skill Bar Label', 'beonepage' ),
					'type' 		=> Controls_Manager::TEXT,
					'label_block' => true,
					],
					[
					'name' 		=> 'section_skill_bar_percentage',
