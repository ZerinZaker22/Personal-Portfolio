...
class Widget_My_Custom_Elementor_client extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$class = '';
		$attribute = '';    
        $beonepage_client_module_bg = beonepage_olddata_fetch('front_page_client_module_bg', 'option');
        if(!empty($beonepage_client_module_bg)){
			$beonepage_client_module_bg = beonepage_olddata_fetch('front_page_client_module_bg', 'option');
        }else{
			$beonepage_client_module_bg = esc_attr("color");
        }       
        $beonepage_client_module_bg_parallax = beonepage_olddata_fetch('front_page_client_module_bg_parallax', 'option');
    ...
    $beonepage_client_module_bg_color = beonepage_olddata_fetch('front_page_client_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_client_module_bg_img = beonepage_olddata_fetch('front_page_client_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_client_module_bg_img_rp = beonepage_olddata_fetch('front_page_client_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_client_module_bg_img_bp = beonepage_olddata_fetch('front_page_client_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_client_module_bg_img_bs = beonepage_olddata_fetch('front_page_client_module_bg_img', 'option');
        ...
        $beonepage_client_module_bg_img_ath = beonepage_olddata_fetch('front_page_client_module_bg_img', 'option');
		...
		'section_clients',
			[
				...
				'fields' 	=> [				
					[
					'name' 		=> 'section_clients_logo_image',
