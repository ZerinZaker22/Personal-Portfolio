...
class Widget_My_Custom_Elementor_Custom extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Title
		$beonepage_custom_module_title = beonepage_olddata_fetch('front_page_custom_module_title', 'option');
        ...
        //Sub title
		$beonepage_custom_module_subtitle = beonepage_olddata_fetch('front_page_custom_module_subtitle', 'option');
		...
		//Caption Animation
		$beonepage_custom_module_animation = beonepage_olddata_fetch('front_page_custom_module_animation', 'option');
		...
		// Font Color
		$beonepage_custom_module_color = beonepage_olddata_fetch('front_page_custom_module_color', 'option');
		...
		//Separator Line
		$beonepage_custom_module_sp_color = beonepage_olddata_fetch('front_page_custom_module_sp_color', 'option');
		...
		//Separator Circle
		$beonepage_custom_module_sp_i_color = beonepage_olddata_fetch('front_page_custom_module_sp_i_color', 'option');
		...
		$class = '';
		$attribute = '';    
        $beonepage_custom_module_bg = beonepage_olddata_fetch('front_page_custom_module_bg', 'option');
		...
		$beonepage_custom_module_bg_color = beonepage_olddata_fetch('front_page_custom_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_custom_module_bg_img = beonepage_olddata_fetch('front_page_custom_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_custom_module_bg_img_rp = beonepage_olddata_fetch('front_page_custom_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_custom_module_bg_img_bp = beonepage_olddata_fetch('front_page_custom_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_custom_module_bg_img_bs = beonepage_olddata_fetch('front_page_custom_module_bg_img', 'option');
        ...
        $beonepage_custom_module_bg_img_ath = beonepage_olddata_fetch('front_page_custom_module_bg_img', 'option');
        ...
        $beonepage_custom_module_bg_video = beonepage_olddata_fetch('front_page_custom_module_bg_video', 'option');
			if(!empty($beonepage_custom_module_bg_video)){
				$beonepage_custom_module_bg_video = beonepage_olddata_fetch('front_custom_table_module_bg_video', 'option');
        ...
        //Parallax seting
        $beonepage_custom_module_bg_parallax = beonepage_olddata_fetch('front_page_custom_module_bg_parallax', 'option');
		...
		//Content Box
		$beonepage_custom_module_content = beonepage_olddata_fetch('front_page_custom_module_content', 'option');
...
protected function render( $instance = [] ) {
	...
	//Layout
	$beonepage_custom_module_layout = beonepage_olddata_fetch('front_page_custom_module_layout', 'option');
	?>
