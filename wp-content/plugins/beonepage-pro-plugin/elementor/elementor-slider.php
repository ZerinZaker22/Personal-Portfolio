...
class Widget_My_Custom_Elementor_Slider extends Widget_Base {
	...
	protected function _register_controls() {
		...
		//Slider type
		$beonepage_text_slider_type = beonepage_olddata_fetch('front_page_slider_type', 'option');
		...
		// Text Title
		$beonepage_text_slider_module_title = beonepage_olddata_fetch('front_page_text_slider_title', 'option');
        ...
        //Text Content
		$beonepage_text_slider_content = beonepage_olddata_fetch('front_page_text_slider_content', 'option');
		...
		//Text Font Color
       $beonepage_text_slider_color = beonepage_olddata_fetch('front_page_text_slider_color', 'option');
		...
		//Text Button TEXT
		$beonepage_text_slider_btn_text = beonepage_olddata_fetch('front_page_text_slider_btn_text', 'option');
		...
		//Text Button Url
		$beonepage_text_slider_btn_url = beonepage_olddata_fetch('front_page_text_slider_btn_url', 'option');
		...
		//Text Button Style
		$beonepage_text_slider_btn_style = beonepage_olddata_fetch('front_page_text_slider_btn_style', 'option');
		...
		$beonepage_text_slider_module_bg_color = beonepage_olddata_fetch('front_page_text_slider_bg', 'option');
        ...
        $beonepage_text_slider_module_bg_img = beonepage_olddata_fetch('front_page_text_slider_bg', 'option');
        ...
        $beonepage_text_slider_module_bg_img_rp = beonepage_olddata_fetch('front_page_text_slider_bg', 'option');
        ...
        $beonepage_text_slider_module_bg_img_bp = beonepage_olddata_fetch('front_page_text_slider_bg', 'option');
        ...
        $beonepage_text_slider_module_bg_img_bs = beonepage_olddata_fetch('front_page_text_slider_bg', 'option');
        ...
        $beonepage_text_slider_module_bg_img_ath = beonepage_olddata_fetch('front_page_text_slider_bg', 'option');
        ...
        //Parallax setting
        $beonepage_text_slider_bg_parallax = beonepage_olddata_fetch('front_page_text_slider_parallax', 'option');
        ...
        $beonepage_text_slider_scroll_down = beonepage_olddata_fetch('front_page_text_slider_scroll_down', 'option');
        ...
        $beonepage_text_swiper_slider_parallax = beonepage_olddata_fetch('front_page_swiper_slider_parallax', 'option');
        ...
        $beonepage_text_swiper_slider_scroll_down = beonepage_olddata_fetch('front_page_swiper_slider_scroll_down', 'option');
		...
		// Font Color
		$beonepage_swiper_slider_color = beonepage_olddata_fetch('front_page_swiper_slider_color', 'option');
		...
		//Swiper Button Style
		$beonepage_swiper_slider_btn_style = beonepage_olddata_fetch('front_page_swiper_slider_btn_style', 'option');
		...
		$beonepage_slider_switch = beonepage_olddata_fetch('front_page_slider_switch', 'option');
        ...
        'section_option_swiper_slider',
			[
				...
				'fields' 	=> [				
					...
					[
					'name' 		=> 'section_slider_heading_animation',
					'label' 	=> __( 'Heading Animation', 'beonepage' ),
					'type' 		=> Controls_Manager::SELECT,
					'options' 	=> beonepage_theme_animate(),
					],
					[
					'name' 		=> 'section_slider_content',
					'label' 	=> 	__( "Content", 'beonepage' ),
					'type' 		=> 	Controls_Manager::TEXTAREA,
					'rows' 		=> 	7,
					],
					[
					'name' 		=> 'section_slider_content_animation',
					'label' 	=> __( 'Content Animation', 'beonepage' ),
					'type' 		=> Controls_Manager::SELECT,
					'options' 	=> beonepage_theme_animate(),
					],
					[
					'name' 		=> 'section_slider_button_text',
					'label' 	=> __( "Button Text", 'beonepage' ),
					'type' 		=> Controls_Manager::TEXT,
					],
					[
					'name' 		=> 'section_slider_button_url',
					'label' 	=> __( "Button Url", 'beonepage' ),
					'type' 		=> Controls_Manager::TEXT,
					'placeholder' => __( 'https://your-link.com', 'beonepage' ),
					],
					[
					'name' 		=> 'section_slider_button_animation',
	...
	$beonepage_slider_time = beonepage_olddata_fetch('front_page_slider_time', 'option');
