...
class Widget_My_Custom_Elementor_Subscribe extends Widget_Base {
	...
	protected function _register_controls() {
		...
		// Heading
		$beonepage_subscribe_title = beonepage_olddata_fetch('front_page_subscribe_title', 'option');
		...
		//Heading Animation
		$beonepage_subscribe_title_animation = beonepage_olddata_fetch('front_page_subscribe_title_animation', 'option');
		...
		//Content
		$beonepage_subscribe_content = beonepage_olddata_fetch('front_page_subscribe_content', 'option');
		...
		//Content Animation
		$beonepage_subscribe_content_animation = beonepage_olddata_fetch('front_page_subscribe_content_animation', 'option');
		...
		// MailChimp API Key
		$beonepage_subscribe_mailchimp_api = beonepage_olddata_fetch('front_page_subscribe_mailchimp_api', 'option');
		...
		// MailChimp List ID
		$beonepage_subscribe_mailchimp_list = beonepage_olddata_fetch('front_page_subscribe_mailchimp_list', 'option');
		...
		// Button Text
		$beonepage_subscribe_btn_text = beonepage_olddata_fetch('front_page_subscribe_btn_text', 'option');
		...
		//Button Animation
		$beonepage_subscribe_btn_animation = beonepage_olddata_fetch('front_page_subscribe_btn_animation', 'option');
		...
		//Button Color
		$beonepage_subscribe_btn_color = beonepage_olddata_fetch('front_page_subscribe_btn_color', 'option');
		...
		//Font Color
		$beonepage_subscribe_color = beonepage_olddata_fetch('front_page_subscribe_color', 'option');
		...
		$class = '';
		$attribute = '';    
        $beonepage_subscribe_module_bg = beonepage_olddata_fetch('front_page_subscribe_module_bg', 'option');
		...
		//Background Color
		$beonepage_subscribe_module_bg_color = beonepage_olddata_fetch('front_page_subscribe_module_bg_color', 'option');
        ...
        //Background image 
        $beonepage_subscribe_module_bg_img = beonepage_olddata_fetch('front_page_subscribe_module_bg_img', 'option');
        ...
        // Background Repeat
        $beonepage_subscribe_module_bg_img_rp = beonepage_olddata_fetch('front_page_subscribe_module_bg_img', 'option');
        ...
        //Background Position
        $beonepage_subscribe_module_bg_img_bp = beonepage_olddata_fetch('front_page_subscribe_module_bg_img', 'option');
        ...
        //Background Size
        $beonepage_subscribe_module_bg_img_bs = beonepage_olddata_fetch('front_page_subscribe_module_bg_img', 'option');
        ...
        $beonepage_subscribe_module_bg_img_ath = beonepage_olddata_fetch('front_page_subscribe_module_bg_img', 'option');
        ...
        //Parallax setting
        $beonepage_subscribe_module_bg_parallax = beonepage_olddata_fetch('front_page_subscribe_module_bg_parallax', 'option');
