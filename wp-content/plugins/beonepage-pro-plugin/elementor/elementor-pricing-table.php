...
protected function _register_controls() {
	...
	// Title
	$beonepage_pricing_table_module_title = beonepage_olddata_fetch('front_page_pricing_table_module_title', 'option');
	...
	$this->add_control(
       ...
       //Sub title
	$beonepage_pricing_table_module_subtitle = beonepage_olddata_fetch('front_page_pricing_table_module_subtitle', 'option');
	...
	//Caption Animation
	$beonepage_pricing_table_module_animation = beonepage_olddata_fetch('front_page_pricing_table_module_animation', 'option');
	...
	// Font Color
	$beonepage_pricing_table_module_color = beonepage_olddata_fetch('front_page_pricing_table_module_color', 'option');
	...
	$beonepage_pricing_table_module_sp_color = beonepage_olddata_fetch('front_page_pricing_table_module_sp_color', 'option');
	...
	$beonepage_pricing_table_module_sp_i_color = beonepage_olddata_fetch('front_page_pricing_table_module_sp_i_color', 'option');
	...
	$beonepage_pricing_table_module_box = beonepage_olddata_fetch('front_page_pricing_table_module_box', 'option');
	...
	$beonepage_pricing_table_module_box_bg = beonepage_olddata_fetch('front_page_pricing_table_module_box_bg', 'option');
	...
	//Button Style
	$beonepage_pricing_table_module_btn_style = beonepage_olddata_fetch('front_page_pricing_table_module_btn_style1', 'option');
	...
	$attribute = '';
       ...
       $beonepage_pricing_table_module_bg = beonepage_olddata_fetch('front_page_pricing_table_module_bg', 'option');
    ...
    //Background Color
    $beonepage_pricing_table_module_bg_color = beonepage_olddata_fetch('front_page_pricing_table_module_bg_color', 'option');
    ...
    //Background image 
    $beonepage_pricing_table_module_bg_img = beonepage_olddata_fetch('front_page_pricing_table_module_bg_img', 'option');
    ...
    // Background Repeat
    $beonepage_pricing_table_module_bg_img_rp = beonepage_olddata_fetch('front_page_pricing_table_module_bg_img', 'option');
    ...
    $this->add_control(
     ...
     //Background Position
    $beonepage_pricing_table_module_bg_img_bp = beonepage_olddata_fetch('front_page_pricing_table_module_bg_img', 'option');
    ...
    $this->add_control(
       ...
       //Background Size
    $beonepage_pricing_table_module_bg_img_bs = beonepage_olddata_fetch('front_page_pricing_table_module_bg_img', 'option');
    ...
    $beonepage_pricing_table_module_bg_img_ath = beonepage_olddata_fetch('front_page_pricing_table_module_bg_img', 'option');
    ...
    $beonepage_pricing_table_module_bg_video = beonepage_olddata_fetch('front_page_pricing_table_module_bg_video', 'option');
    ...
    //Parallax setting
	$beonepage_pricing_table_module_bg_parallax = beonepage_olddata_fetch('front_page_pricing_table_module_bg_parallax', 'option');
	...
	'section_pricing_table_boxes',
		[
			...
			'fields' 	=> [
				[
				'name' 		=> 'section_pricing_table_pick',
				...
				[
				'name' 		=> 'section_pricing_table_title',
				'label' 	=> __( "Title", 'beonepage' ),
				'type' 		=> Controls_Manager::TEXT,
				],
				[
				'name' 		=> 'section_pricing_table_currency',
				'label' 	=> __( "Currency", 'beonepage' ),
				'type' 		=> Controls_Manager::TEXT,
				'description'=> 'Input your desired currency symbol here. e.g. "$".',
				],
				[
				'name' 		=> 'section_pricing_table_duration',
				...
				[
				'name' 		=> 'section_pricing_table_price',
				'label' 	=> __( "Price", 'beonepage' ),
				'type' 		=> Controls_Manager::TEXT,
				],
				[
				'name' 		=> 'section_pricing_table_button_text',
				'label' 	=> __( "Button Text", 'beonepage' ),
				'type' 		=> Controls_Manager::TEXT,
				],
				[
				'name' 		=> 'section_pricing_table_button_url',
				'label' 	=> __( "Button URL", 'beonepage' ),
				'type' 		=> Controls_Manager::TEXT,
				'placeholder' => __( 'https://your-link.com', 'beonepage' ),
				],
				[
				'name' 		=> 'section_pricing_table_animation',
				'label' 	=> __( 'Animation', 'beonepage' ),
				'type' 		=> Controls_Manager::SELECT,
				'options' 	=> beonepage_theme_animate(),
				],
				[
				'name' 		=> 'section_pricing_table_content',
